...
<body>
    ...
    <script>
     ...
     <script>
		 	//웹소켓 연결(웹 브라우저에서 실행)
		    const socketLike = new SockJS("http://192.168.30.165:8083${contextPath}/websocket"); //URL에 대한 WebSocket 연결을 설정
    ...
    $(function() {
        ...
        const socketShare = new SockJS('http://192.168.30.165:8083/dot/websocket');
...
//            console.log(feedNo);
    ...
    <script>
        //사이드바 친구추천
         const socketFollow5 = new SockJS("http://192.168.30.165:8083${contextPath}/websocket"); //URL에 대한 WebSocket 연결을 설정
